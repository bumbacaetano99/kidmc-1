...
if (isset($_POST['nome_usuario'])) {
    ...
    $query ="select * from user where usuario= '".$nome_usuario."' AND senha= '".$usuario_senha."' limit 1";
        ...
        <div class="content">
            <form method="post">
                ...
                <div class="cartao">
                    ...
                    <input type="password" name="usuario_senha" placeholder="Digite a senha..." required>
